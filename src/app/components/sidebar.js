...
function Sidebar() {
  return (
    <div className="w-full">
      <div className="p-4 md:p-8 bg-primary/25 h-full w-full shadow-[0_3px_10px_rgb(255, 255, 255,0.5)] rounded-lg backdrop-blur-md">
        {/* SIDEBAR INNER */}
        <div className="flex justify-center md:justify-start items-center gap-2 pb-2 md:pb-6 font-semibold text-xs md:text-sm text-gray-600 w-full overflow-hidden">
          Menu{" "}
          <span className="min-w-full border-t-2 hidden md:flex border-gray-600"></span>
        </div>
