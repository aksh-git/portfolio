    ...
    <section className="w-full min-h-screen px-8 md:px-12 lg:px-28 flex flex-col-reverse md:flex-row items-center justify-end md:justify-between">
      ...
      <div className="min-w-full md:min-w-min">
        ...
        <div
          ...
          className="py-2 px-6 bg-accent w-fit mt-6 rounded-full font-medium cursor-pointer text-slate-200 flex items-center gap-1"
        >
          About me
        ...
        <div className="mt-8">
          ...
          <div className="flex flex-row gap-1 -ml-2">
            ...
            <SocialButton altText="Github Profile" url="github.com/aksh-git">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28"
                height="28"
            ...
            <SocialButton altText="X (formerly twitter)" url="x.com/ydevakash">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
